...
ActiveRecord::Schema.define(version: 20160731090300) do
  ...
  add_index "appusers", ["reset_password_token"], name: "index_appusers_on_reset_password_token", unique: true, using: :btree
